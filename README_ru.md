...
- [Скриншоты](#скриншоты)
  ...
  - [Разделение окна редактора кода](#разделение-окна-редактора-кода)
...
### Разделение окна редактора кода
...
1. Установите средства сборки Microsoft Visual Studio с набором инструментов для C++: https://visualstudio.microsoft.com/downloads/
2. Установите Nuitka:
```
pip install nuitka
```
